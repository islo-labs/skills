...
5. Harness code ships in sandbox snapshots; repo skills and prompts reach agents via `sandbox.sources[]` checkout plus a short literal prompt, never copied into manifests or Knowledge.
