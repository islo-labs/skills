...
| Artifact refs: what a run produced; ArtifactRef schema and provider shapes | `islo schema job-run --short` for the output contract, then `references/artifact-refs.md` for policy |
